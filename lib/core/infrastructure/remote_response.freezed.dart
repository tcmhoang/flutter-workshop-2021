...
class _$_NoConnection<T> extends _NoConnection<T> with DiagnosticableTreeMixin {
...
class _$_NotModified<T> extends _NotModified<T> with DiagnosticableTreeMixin {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'RemoteResponse<$T>.notModified'))
...
class _$_WithNewData<T> extends _WithNewData<T> with DiagnosticableTreeMixin {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'RemoteResponse<$T>.withNewData'))
