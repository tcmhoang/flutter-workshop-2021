...
class _$_Server extends _Server with DiagnosticableTreeMixin {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'AuthFailure.server'))
...
class _$_Storage extends _Storage with DiagnosticableTreeMixin {
